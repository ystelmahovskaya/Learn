...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    public static class GeneralPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(final Bundle savedInstanceState) {
            ...
            Preference remove_statistics = (Preference) findPreference("remove_statistics");
            remove_statistics.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            ...
            remove_profile.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
